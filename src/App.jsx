      ...
      <div className="container mx-auto space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mx-10 xl:mx-0">
          ...
          <div className="space-y-5">
            <p className="leading-6 text-start">
              I am a seasoned software engineer with 1 years of experience in
              the field. Passionate about software engineering, I thrive on
              challenges encountered during the development process. To me,
              software engineering is not just a profession, but a vibrant
              passion that ignites creativity and innovation. Whether tackling
              complex algorithms or architecting elegant solutions, I approach
              each task with enthusiasm and dedication.
            </p>

            <div className="space-y-1 font-[consolas] bg-white dark:bg-black p-4 border border-gray-300 dark:border-slate-700 rounded-md">
              <div>AndikaClients.java</div>
              <hr />
              <br />
              <p>{"LinkedList<String> myClients = new LinkedList<>()"}</p>
              <p>
                myRecentClientsList.add(
          ...
          <div className="space-y-5">
            <p className="leading-6 text-start">
              Consistency, reliability, and client satisfaction define my
              approach to software engineering. The software solutions I develop
              are not merely good—they exceed expectations, offering robust
              functionality, seamless performance, and intuitive user
              experiences. My track record speaks for itself, as I continually
              strive to uphold the highest standards of excellence in every
              project I undertake.
            </p>
          </div>
        </div>
